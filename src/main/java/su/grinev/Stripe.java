...
public class Stripe {
    ...
    public void draw(Graphics g) {
        ...
        matrixElements.forEach(matrixElement -> {
            if (matrixElement.getColorIndex() == 0) g.setColor(new Color(0xFFFFFF)); else
                if (matrixElement.getColorIndex() >= 1 && matrixElement.getColorIndex() <= 3) g.setColor(new Color(0x00FFFF)); else
                    if (matrixElement.getColorIndex() >= 4 && matrixElement.getColorIndex() <= 8) g.setColor(new Color(0x00FF70));
